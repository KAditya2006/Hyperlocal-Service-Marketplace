    ...
    <div className="min-h-screen bg-slate-50 flex flex-col md:flex-row">
      ...
      <div className="hidden md:flex md:w-1/2 bg-primary-600 p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10">
          <Link to="/" className="text-3xl font-bold text-white font-heading">HyperlocalMarket</Link>
          <div className="mt-24 max-w-lg">
            <h2 className="text-5xl font-bold text-white font-heading leading-tight mb-6">
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center p-6 md:p-12">
        <div className="w-full max-w-md">
          <div className="mb-10 text-center md:text-left">
            <h3 className="text-3xl font-bold font-heading text-slate-900 mb-2">Create an Account</h3>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="flex bg-white p-1 rounded-xl border border-slate-200 gap-1">
              <button 
                ...
                className={`flex-1 py-2 text-sm font-bold rounded-lg transition-all ${formData.role === 'user' ? 'bg-primary-600 text-white shadow-lg' : 'text-slate-500 hover:bg-slate-50'}`}
              >
                I'm a Customer
              </button>
              <button 
                ...
                className={`flex-1 py-2 text-sm font-bold rounded-lg transition-all ${formData.role === 'worker' ? 'bg-primary-600 text-white shadow-lg' : 'text-slate-500 hover:bg-slate-50'}`}
              >
                I'm a Worker
              </button>
            </div>
